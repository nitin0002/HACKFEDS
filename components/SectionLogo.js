...
const SectionLogo = () => {
  return (
    <div className="flex flex-col md:flex items-center justify-center h-screen">
      ...
      <h3 className="pl-px m-2 text-base font-medium leading-7 antialiased tracking-tight font-sans  text-slate-200 capitalize sm:text-lg">
      ...
      <div className="flex flex-col  sm:flex-row space-x-4 mt-8 justify-items-center sm:justify-items-start">
        <a href="https://discord.gg/Rw97jUCn6k" target="_blank" className="justify-items-center pl-16 sm:pl-2">
