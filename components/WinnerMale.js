...
<div className="flex-wrap items-center justify-center gap-8 text-center sm:flex mx-5 ">
    <div className="w-full px-4 py-4 mt-6 bg-white rounded-lg shadow-lg sm:w-1/2 md:w-1/2 lg:w-1/4 dark:bg-gray-800">
        ...
        <h3 className="py-4 text-2xl font-semibold text-gray-700  lg:text-3xl sm:text-xl dark:text-white">
            1st Runner Up
        </h3>
    ...
    <div className="w-full px-4 py-4 mt-6 bg-white rounded-lg shadow-lg sm:w-1/2 md:w-1/2 lg:w-1/4 sm:mt-16 md:mt-20 lg:-mt-24 dark:bg-gray-800 backdrop-filter backdrop-blur-sm">
        <div className="flex-shrink-0">
            <div className="flex items-center justify-center w-20 h-20 mx-auto text-white bg-indigo-500 rounded-md">
                <Medal />
                <svg width="20" height="20" fill="currentColor" className="w-6 h-6" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
        ...
        <h3 className="py-4 text-3xl font-semibold text-gray-700 lg:text-4xl sm:text-xl dark:text-amber-300  
">
             Winner
        </h3>
        <p className="py-4 text-gray-500 text-md dark:text-gray-300">
