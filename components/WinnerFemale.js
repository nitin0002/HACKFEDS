...
<div className="flex-wrap items-center justify-center gap-8 text-center sm:flex mx-5">
    ...
    <div className="w-full px-4 py-4 mt-6 bg-white rounded-lg shadow-lg sm:w-1/2 md:w-1/2 lg:w-1/4 sm:mt-16 md:mt-20 lg:mt-24 dark:bg-gray-800">
        ...
        <h3 className="py-4 text-2xl font-semibold text-gray-700 lg:text-4xl sm:text-xl dark:text-amber-400">
            Best Solo Hacker
        </h3>
        <p className="py-4 text-gray-500 text-md dark:text-gray-300">
    ...
    <div className="w-full px-4 py-4 mt-6 bg-white rounded-lg shadow-lg sm:w-1/2 md:w-1/2 lg:w-1/4 dark:bg-gray-800">
        ...
        <h3 className="py-4 text-2xl font-semibold text-gray-700lg:text-3xl sm:text-xl dark:text-white">
            2nd Best Women Team
        </h3>
        <p className="py-4 text-gray-500 text-md dark:text-gray-300">
